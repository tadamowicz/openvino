...
intel_dnn_component_t & GNAPluginNS::DnnComponents::addComponent(const std::string layerName, const std::string layerMetaType) {
...
intel_dnn_component_t * GNAPluginNS::DnnComponents::findComponent(InferenceEngine::CNNLayerPtr __layer) {
